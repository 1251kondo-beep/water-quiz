...
export default function CoursePage() {
  ...
  // Find course index in domain
  const domain = DOMAINS.find((d) => d.courses.some((c) => c.id === course.id));
  ...
  return (
    <div className={`flex-1 w-full flex flex-col ${theme.pageBg} pb-16 relative overflow-x-hidden transition-colors duration-500`}>
      ...
      {/* Header Bar matching Course Theme */}
      <div className={`sticky top-0 z-40 ${theme.headerBg} backdrop-blur-md border-b ${theme.headerBorder} px-4 py-3 shadow-sm`}>
