...
export const COURSE_PAGE_THEMES: Record<string, CourseTheme> = {
  ...
  water_design: {
    id: 'water_design',
    name: '碧流ロイヤルサファイア',
    gradient: 'bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-950',
    border: 'border-blue-400',
    shadow: 'shadow-blue-600/25',
    tagBg: 'bg-white/25',
    waveType: 5,
    pageBg: 'bg-gradient-to-b from-blue-100/80 via-sky-50/40 to-blue-100/70',
    headerBg: 'bg-blue-200/90',
    headerBorder: 'border-blue-300/80',
    courseBadgeBg: 'bg-gradient-to-r from-blue-700 to-indigo-900 text-white',
    progressBarGradient: 'from-blue-500 via-blue-600 to-indigo-800',
    progressTrackBg: 'bg-blue-100 border-blue-200',
    progressCardBorder: 'border-blue-200',
    sectionJumpBtn: 'bg-blue-50 text-blue-950 hover:bg-blue-100 border-blue-200',
    sectionJumpBadge: 'bg-blue-200 text-blue-900',
    sectionHeaderBadge: 'bg-gradient-to-r from-blue-800 via-blue-900 to-indigo-950 text-white shadow-blue-600/30',
    streamGradStart: '#2563eb',
    streamGradMid: '#1d4ed8',
    streamGradEnd: '#1e3a8a',
    streamBaseColor: '#bfdbfe',
    nodeCompletedGrad: 'from-blue-500 to-blue-700',
    nodeActiveGrad: 'from-blue-600 to-indigo-900',
    nodeCompletedBorder: 'border-blue-300',
    nodeActiveBorder: 'border-blue-600',
    nodeActiveRing: 'ring-blue-400/60',
    bgBlur1: 'bg-blue-300/40',
    bgBlur2: 'bg-blue-200/50',
    bgBlur3: 'bg-indigo-200/40',
    accentText: 'text-blue-800',
    quiz: {
      lessonTitle: 'text-blue-950 dark:text-blue-200',
      qBadge: 'bg-blue-600 dark:bg-blue-500',
      progressBar: 'from-blue-500 via-blue-600 to-indigo-800',
      optionHoverBorder: 'hover:border-blue-400',
      optionSelectedBg: 'bg-blue-50/80 dark:bg-blue-950/70',
      optionSelectedBorder: 'border-blue-600',
      optionSelectedText: 'text-blue-950 dark:text-blue-100',
      optionBadge: 'bg-blue-100/80 dark:bg-blue-900/60 text-blue-800 dark:text-blue-300',
      optionBadgeActive: 'bg-blue-600 text-white',
      checkBadge: 'border-blue-600 bg-blue-600 text-white',
      tfCircleGrad: 'bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-800 text-white shadow-md shadow-blue-500/25',
      tfSelectedRing: 'border-blue-600 ring-4 ring-blue-500/40 bg-blue-50/90 dark:bg-blue-950/70',
      multiSelectNotice: 'text-blue-950 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/60 border-blue-200 dark:border-blue-800/60',
      multiSelectBadge: 'bg-blue-600 text-white',
      confirmBtnGradient: 'bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 hover:from-blue-500 hover:to-indigo-700 text-white shadow-blue-500/25',
      accentText: 'text-blue-700 dark:text-blue-400',
      cardBorder: 'border-blue-200/80 dark:border-blue-800/60',
      widgetCardBg: 'bg-blue-50/60 dark:bg-slate-900/70 border-blue-200/90 dark:border-blue-800/60',
      widgetActiveBorder: 'border-blue-600',
      widgetActiveRing: 'ring-blue-400/40',
      widgetActiveBg: 'bg-blue-100/90 dark:bg-blue-950/80 text-blue-950 dark:text-blue-100',
    },
  },
  water_asset: {
    id: 'water_asset',
  ...
  tech_admin: {
    id: 'tech_admin',
    name: '水道行政ロイヤルブルー',
    gradient: 'bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-600',
    border: 'border-blue-400',
    shadow: 'shadow-blue-500/25',
    tagBg: 'bg-white/25',
    waveType: 5,
    pageBg: 'bg-gradient-to-b from-blue-100/75 via-indigo-50/50 to-cyan-100/60',
    headerBg: 'bg-blue-200/90',
    headerBorder: 'border-blue-300/80',
    courseBadgeBg: 'bg-gradient-to-r from-blue-700 via-indigo-700 to-cyan-700 text-white font-black',
    progressBarGradient: 'from-blue-600 via-indigo-600 to-cyan-500',
    progressTrackBg: 'bg-blue-100 border-blue-200',
    progressCardBorder: 'border-blue-200',
    sectionJumpBtn: 'bg-blue-50 text-blue-950 hover:bg-blue-100 border-blue-200',
    sectionJumpBadge: 'bg-blue-200 text-blue-900',
    sectionHeaderBadge: 'bg-gradient-to-r from-blue-700 via-indigo-700 to-cyan-700 text-white shadow-blue-500/25',
    streamGradStart: '#1d4ed8',
    streamGradMid: '#4338ca',
    streamGradEnd: '#0891b2',
    streamBaseColor: '#bfdbfe',
    nodeCompletedGrad: 'from-blue-500 via-indigo-500 to-cyan-500',
    nodeActiveGrad: 'from-blue-600 via-indigo-600 to-cyan-600',
    nodeCompletedBorder: 'border-blue-300',
    nodeActiveBorder: 'border-blue-600',
    nodeActiveRing: 'ring-blue-300/60',
    bgBlur1: 'bg-blue-200/50',
    bgBlur2: 'bg-indigo-200/50',
    bgBlur3: 'bg-cyan-200/50',
    accentText: 'text-blue-800',
    quiz: {
      lessonTitle: 'text-blue-950 dark:text-blue-100',
      qBadge: 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white',
      progressBar: 'from-blue-600 via-indigo-600 to-cyan-500',
      optionHoverBorder: 'hover:border-blue-400',
      optionSelectedBg: 'bg-blue-50/80 dark:bg-blue-950/70',
      optionSelectedBorder: 'border-blue-600',
      optionSelectedText: 'text-blue-950 dark:text-blue-100',
      ...
      optionBadgeActive: 'bg-blue-600 text-white',
      checkBadge: 'border-blue-600 bg-blue-600 text-white',
      tfCircleGrad: 'bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-600 text-white shadow-md shadow-blue-500/25',
      tfSelectedRing: 'border-blue-600 ring-4 ring-blue-500/40 bg-blue-50/90 dark:bg-blue-950/70',
      multiSelectNotice: 'text-blue-950 dark:text-blue-200 bg-blue-50 dark:bg-slate-900/60 border-blue-200 dark:border-blue-800/60',
      multiSelectBadge: 'bg-blue-600 text-white',
      confirmBtnGradient: 'bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white shadow-blue-500/25',
      accentText: 'text-blue-700 dark:text-blue-400',
      cardBorder: 'border-blue-200/80 dark:border-blue-800/60',
      widgetCardBg: 'bg-blue-50/60 dark:bg-slate-900/70 border-blue-200/90 dark:border-blue-800/60',
      widgetActiveBorder: 'border-blue-600',
